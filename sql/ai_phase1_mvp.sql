...
(
    ...
    output_schema    text,
    advisor_codes    varchar(512) default null comment 'comma-separated advisor codes',
    token_budget     int          default null comment 'max token budget per execution',
    tool_budget      int          default null comment 'max tool calls per execution',
